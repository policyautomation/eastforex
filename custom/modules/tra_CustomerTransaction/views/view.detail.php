...
class tra_CustomerTransactionViewDetail extends ViewDetail
{
     ...
     */
    public function tra_CustomerTransactionViewDetail()
    {
    ...
    {
        $this->populateCustomerTransactionTemplates();
        $this->displayPopupHtml();
        parent::display();
    }

    public function populateCustomerTransactionTemplates()
    {
        global $app_list_strings;

        $sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted = 0 AND type='tra_CustomerTransaction' AND active = 1";
