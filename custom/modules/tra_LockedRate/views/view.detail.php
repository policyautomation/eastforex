...
class tra_LockedRateViewDetail extends ViewDetail
{
     ...
     */
    public function tra_LockedRateViewDetail()
    {
    ...
    {
        $this->populateLockedRateTemplates();
        $this->displayPopupHtml();
        parent::display();
    }

    public function populateLockedRateTemplates()
    {
        global $app_list_strings;

        $sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted = 0 AND type='tra_LockedRate' AND active = 1";
