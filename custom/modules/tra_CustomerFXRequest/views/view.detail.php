...
class tra_CustomerFXRequestViewDetail extends ViewDetail
{
     ...
     */
    public function tra_CustomerFXRequestViewDetail()
    {
    ...
    {
        $this->populateCustomerFXRequestTemplates();
        $this->displayPopupHtml();
        parent::display();
    }

    public function populateCustomerFXRequestTemplates()
    {
        global $app_list_strings;

        $sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted = 0 AND type='tra_CustomerFXRequest' AND active = 1";
