...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_LEVEL' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.level_c.name}" 
id="{$fields.level_c.name}" 
title=''       
>
{if isset($fields.level_c.value) && $fields.level_c.value != ''}
{html_options options=$fields.level_c.options selected=$fields.level_c.value}
{else}
{html_options options=$fields.level_c.options selected=$fields.level_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.level_c.options }
{capture name="field_val"}{$fields.level_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.level_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.level_c.name}" 
id="{$fields.level_c.name}" 
title=''          
>
{if isset($fields.level_c.value) && $fields.level_c.value != ''}
...
<input
id="{$fields.level_c.name}-input"
name="{$fields.level_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.level_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.level_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.level_c.name}-input', '{$fields.level_c.name}');sync_{$fields.level_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.level_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.level_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.level_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.level_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.level_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.level_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.level_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_STATUS' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MOBILE_NUMBER_ALT' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.mobile_number_alt_c.value) <= 0}
{assign var="value" value=$fields.mobile_number_alt_c.default_value }
{else}
{assign var="value" value=$fields.mobile_number_alt_c.value }
{/if}  
<input type='text' name='{$fields.mobile_number_alt_c.name}' id='{$fields.mobile_number_alt_c.name}' size='30' maxlength='255' value='{$value}' title='' tabindex='0'	  class="phone" >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_REFERRER' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.first_name_c.value) <= 0}
{assign var="value" value=$fields.first_name_c.default_value }
{else}
{assign var="value" value=$fields.first_name_c.value }
{/if}  
<input type='text' name='{$fields.first_name_c.name}' 
id='{$fields.first_name_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MIDDLE_NAME' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.last_name_c.value) <= 0}
{assign var="value" value=$fields.last_name_c.default_value }
{else}
{assign var="value" value=$fields.last_name_c.value }
{/if}  
<input type='text' name='{$fields.last_name_c.name}' 
id='{$fields.last_name_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DOB' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OCCUPATION' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.occupation_c.name}" 
id="{$fields.occupation_c.name}" 
title=''       
>
{if isset($fields.occupation_c.value) && $fields.occupation_c.value != ''}
{html_options options=$fields.occupation_c.options selected=$fields.occupation_c.value}
{else}
{html_options options=$fields.occupation_c.options selected=$fields.occupation_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.occupation_c.options }
{capture name="field_val"}{$fields.occupation_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.occupation_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.occupation_c.name}" 
id="{$fields.occupation_c.name}" 
title=''          
>
{if isset($fields.occupation_c.value) && $fields.occupation_c.value != ''}
...
<input
id="{$fields.occupation_c.name}-input"
name="{$fields.occupation_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.occupation_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.occupation_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.occupation_c.name}-input', '{$fields.occupation_c.name}');sync_{$fields.occupation_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.occupation_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.occupation_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.occupation_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.occupation_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.occupation_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.occupation_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.occupation_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_WECHAT_ID' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.wechat_id_c.value) <= 0}
{assign var="value" value=$fields.wechat_id_c.default_value }
{else}
{assign var="value" value=$fields.wechat_id_c.value }
{/if}  
<input type='text' name='{$fields.wechat_id_c.name}' 
id='{$fields.wechat_id_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OCCUPATION_OTHER' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.occupation_other_c.value) <= 0}
{assign var="value" value=$fields.occupation_other_c.default_value }
{else}
{assign var="value" value=$fields.occupation_other_c.value }
{/if}  
<input type='text' name='{$fields.occupation_other_c.name}' 
id='{$fields.occupation_other_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_LINKED_COMPANY' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.linked_company_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.linked_company_c.name}" size="" value="{$fields.linked_company_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.linked_company_c.id_name}" 
id="{$fields.linked_company_c.id_name}" 
value="{$fields.account_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.linked_company_c.name}" id="btn_{$fields.linked_company_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
"{$fields.linked_company_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id_c","name":"linked_company_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.linked_company_c.name}" id="btn_clr_{$fields.linked_company_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.linked_company_c.name}', '{$fields.linked_company_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.linked_company_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_COMPANY_NAME' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ABN' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.abn_c.value) <= 0}
{assign var="value" value=$fields.abn_c.default_value }
{else}
{assign var="value" value=$fields.abn_c.value }
{/if}  
<input type='text' name='{$fields.abn_c.name}' 
id='{$fields.abn_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_REGULATED_AUTHORITY' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.regulated_authority_c.value) <= 0}
{assign var="value" value=$fields.regulated_authority_c.default_value }
{else}
{assign var="value" value=$fields.regulated_authority_c.value }
{/if}  
<input type='text' name='{$fields.regulated_authority_c.name}' 
id='{$fields.regulated_authority_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_STRUCTURE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.structure_c.name}" 
id="{$fields.structure_c.name}" 
title=''       
>
{if isset($fields.structure_c.value) && $fields.structure_c.value != ''}
{html_options options=$fields.structure_c.options selected=$fields.structure_c.value}
{else}
{html_options options=$fields.structure_c.options selected=$fields.structure_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.structure_c.options }
{capture name="field_val"}{$fields.structure_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.structure_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.structure_c.name}" 
id="{$fields.structure_c.name}" 
title=''          
>
{if isset($fields.structure_c.value) && $fields.structure_c.value != ''}
...
<input
id="{$fields.structure_c.name}-input"
name="{$fields.structure_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.structure_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.structure_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.structure_c.name}-input', '{$fields.structure_c.name}');sync_{$fields.structure_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.structure_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.structure_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.structure_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.structure_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.structure_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.structure_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.structure_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
addToValidate('EditView', 'middle_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MIDDLE_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'occupation_c', 'enum', false,'{/literal}{sugar_translate label='LBL_OCCUPATION' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'occupation_other_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OCCUPATION_OTHER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'last_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'type_c', 'enum', true,'{/literal}{sugar_translate label='LBL_TYPE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'mobile_number_alt_c', 'phone', false,'{/literal}{sugar_translate label='LBL_MOBILE_NUMBER_ALT' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'linked_company_c', 'relate', false,'{/literal}{sugar_translate label='LBL_LINKED_COMPANY' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'level_c', 'enum', false,'{/literal}{sugar_translate label='LBL_LEVEL' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'abn_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ABN' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'company_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COMPANY_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'first_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FIRST_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'account_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_LINKED_COMPANY_ACCOUNT_ID' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'structure_c', 'enum', false,'{/literal}{sugar_translate label='LBL_STRUCTURE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'referrer_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_REFERRER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'customer_number_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CUSTOMER_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'dob_c', 'date', false,'{/literal}{sugar_translate label='LBL_DOB' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'regulated_authority_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_REGULATED_AUTHORITY' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'wechat_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_WECHAT_ID' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'status_c', 'enum', true,'{/literal}{sugar_translate label='LBL_STATUS' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'linked_company_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_LINKED_COMPANY' module='Accounts' for_js=true}{literal}', 'account_id_c' );
