...
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOMER_NUMBER' module='Accounts'}{/capture}
...
{if !$fields.customer_number_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.customer_number_c.name}">{$fields.customer_number_c.value}</span>
{/if}
...
{if !$fields.level_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.level_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.level_c.name}" value="{ $fields.level_c.options }">
{ $fields.level_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.level_c.name}" value="{ $fields.level_c.value }">
{ $fields.level_c.options[$fields.level_c.value]}
{/if}
{/if}
...
{if !$fields.mobile_number_alt_c.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.mobile_number_alt_c.value)}
{assign var="phone_value" value=$fields.mobile_number_alt_c.value }
{sugar_phone value=$phone_value usa_format="0"}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.referrer_c.name}">{$fields.referrer_c.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.first_name_c.name}">{$fields.first_name_c.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.last_name_c.name}">{$fields.last_name_c.value}</span>
{/if}
...
{if !$fields.dob_c.hidden}
{counter name="panelFieldCount" print=false}


{if strlen($fields.dob_c.value) <= 0}
{assign var="value" value=$fields.dob_c.default_value }
{else}
{assign var="value" value=$fields.dob_c.value }
{/if}
<span class="sugar_field" id="{$fields.dob_c.name}">{$value}</span>
{/if}
...
{if is_string($fields.occupation_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.occupation_c.name}" value="{ $fields.occupation_c.options }">
{ $fields.occupation_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.occupation_c.name}" value="{ $fields.occupation_c.value }">
{ $fields.occupation_c.options[$fields.occupation_c.value]}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.wechat_id_c.name}">{$fields.wechat_id_c.value}</span>
{/if}
...
{if !$fields.occupation_other_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.occupation_other_c.name}">{$fields.occupation_other_c.value}</span>
{/if}
...
{if !$fields.linked_company_c.hidden}
{counter name="panelFieldCount" print=false}
...
<span id="account_id_c" class="sugar_field" data-id-value="{$fields.account_id_c.value}">{$fields.linked_company_c.value}</span>
...
{/if} 
<span class="sugar_field" id="{$fields.abn_c.name}">{$fields.abn_c.value}</span>
{/if}
...
{if !$fields.regulated_authority_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.regulated_authority_c.name}">{$fields.regulated_authority_c.value}</span>
{/if}
...
{if !$fields.structure_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.structure_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.structure_c.name}" value="{ $fields.structure_c.options }">
{ $fields.structure_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.structure_c.name}" value="{ $fields.structure_c.value }">
{ $fields.structure_c.options[$fields.structure_c.value]}
{/if}
{/if}
